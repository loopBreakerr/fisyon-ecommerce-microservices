...
/**
 * payment domain'i icin ayri DataSource/EntityManagerFactory/TransactionManager
 * ucgeni. Detayli aciklama icin bkz. CatalogDataSourceConfig.
 */
@Configuration(proxyBeanMethods = false)
@EnableJpaRepositories(
        basePackages = "com.ecommerce.core_service.payment",
...
public class PaymentDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean paymentEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.ecommerce.core_service.payment")
