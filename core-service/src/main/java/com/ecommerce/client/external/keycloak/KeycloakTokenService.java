...
public class KeycloakTokenService {
    ...
    public KeycloakTokenService(@Value("${keycloak.admin.token-uri}") String tokenUri,
        ...
        // Projede spring-boot-starter-webmvc kullaniliyor; Boot 4'un moduler
        // starter yapisinda bu, RestClient.Builder bean'ini otomatik
        // konfigure etmiyor (ayri bir modulde). Yeni bir dependency
        // eklemek yerine RestClient'i dogrudan olusturuyoruz - bu sinif
        // zaten spring-web'in (spring-webmvc ile classpath'te) bir parcasi.
